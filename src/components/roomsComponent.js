...
const GET_USERS_URL = 'http://conferencereservation.us-west-2.elasticbeanstalk.com/api/v1/rooms?'
        ...
        editable={{
          onRowAdd: newData =>
            new Promise((resolve, reject) => {
                ...
                let url = `http://conferencereservation.us-west-2.elasticbeanstalk.com/api/v1/rooms`;
          ...
          onRowUpdate: (newData, oldData) =>         
            new Promise((resolve, reject) => {
              ...
              let url = `http://conferencereservation.us-west-2.elasticbeanstalk.com/api/v1/rooms/${roomId}`;
              console.debug(`request url: ${url}`);
